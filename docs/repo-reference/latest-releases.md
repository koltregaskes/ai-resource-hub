...
| 21 Jul 2026 | Gemini 3.6 Flash (batch) | Google | tracking | backfill | ready for editor | 0 | 2 | [official](https://ai.google.dev/gemini-api/docs/models/gemini-3.6-flash) |
| 21 Jul 2026 | Gemini 3.5 Flash Lite (batch) | Google | tracking | backfill | ready for editor | 0 | 2 | [official](https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite) |
