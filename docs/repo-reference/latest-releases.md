...
| 2 Apr 2026 | Gemma 4 31B | Google | tracking | high | ready for editor | 0 | 5 | [official](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/) |
...
| 5 Mar 2026 | GPT-5.4 | OpenAI | tracking | watch | ready for editor | 0 | 6 | [official](https://developers.openai.com/api/docs/guides/latest-model) |
| 5 Mar 2026 | GPT-5.4 Pro | OpenAI | tracking | watch | ready for editor | 0 | 6 | [official](https://developers.openai.com/api/docs/guides/latest-model) |
| 3 Mar 2026 | GPT-5.3 Chat | OpenAI | tracking | watch | ready for editor | 0 | 6 | [official](https://platform.openai.com/docs/models) |
