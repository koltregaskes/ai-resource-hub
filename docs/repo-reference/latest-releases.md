...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 9 Jul 2026 | GPT-5.6 Luna Pro | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
| 9 Jul 2026 | GPT-5.6 Luna | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
| 9 Jul 2026 | GPT-5.6 Terra Pro | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
| 9 Jul 2026 | GPT-5.6 Terra | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
| 9 Jul 2026 | GPT-5.6 Sol Pro | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
| 9 Jul 2026 | GPT-5.6 Sol | OpenAI | tracking | high | ready for editor | 0 | 1 | [official](https://platform.openai.com/docs/models) |
...
| 27 May 2026 | Claude Opus 4.8 (Fast) | Anthropic | tracking | watch | ready for editor | 0 | 2 | [official](https://docs.anthropic.com) |
