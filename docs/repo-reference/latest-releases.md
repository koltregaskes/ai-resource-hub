...
| 24 Jul 2026 | Claude Opus 5 (batch) | Anthropic | tracking | high | ready for editor | 0 | 3 | [official](https://www.anthropic.com/news/claude-opus-5) |
...
| 21 Jul 2026 | Gemini 3.6 Flash (batch) | Google | tracking | high | needs research | 0 | 0 | [official](https://ai.google.dev/gemini-api/docs/models/gemini-3.6-flash) |
| 21 Jul 2026 | Gemini 3.5 Flash Lite (batch) | Google | tracking | high | needs research | 0 | 0 | [official](https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite) |
...
| 9 Jul 2026 | GPT-5.6 Terra (batch) | OpenAI | tracking | watch | ready for editor | 0 | 4 | [official](https://developers.openai.com/api/docs/models/gpt-5.6-terra) |
| 9 Jul 2026 | GPT-5.6 Luna (batch) | OpenAI | tracking | watch | ready for editor | 0 | 5 | [official](https://developers.openai.com/api/docs/models/gpt-5.6-luna) |
