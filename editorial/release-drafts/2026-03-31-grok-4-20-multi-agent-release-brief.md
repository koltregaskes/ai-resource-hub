...
generated_at: "2026-04-09T12:02:58.378Z"
---

# Grok 4.20 Multi-Agent: release brief

xAI's Grok 4.20 Multi-Agent is on the release desk with 0 related storyies and 0 benchmark signals to review.

## Release summary

Grok 4.20 Multi-Agent is a currently tracked release from xAI. It is positioned as an API-available model rather than a local-only release. Tracked context window: 2M tokens. Current tracked pricing: $2.00 in / $6.00 out per million tokens. xAI multi-agent Grok variant. Tracking only until benchmark and quality coverage is available. xAI multi-agent Grok variant. xAI multi-agent Grok variant. xAI multi-agent Grok variant. xAI multi-agent Grok variant. xAI multi-agent Grok variant. xAI multi-agent Grok variant. There is an official launch or documentation URL attached, so this is ready for source-first editorial work.
