...
1. Lead with the hook: what MiniMax actually launched with MiniMax M2.1, and why it matters now.
...
5. Keep the chronology explicit: this release landed on 23 Dec 2025 and should be framed against the models it is replacing or competing with.
