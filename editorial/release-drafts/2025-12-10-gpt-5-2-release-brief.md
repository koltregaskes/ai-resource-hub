---
title: "GPT-5.2: release brief"
slug: "2025-12-10-gpt-5-2-release-brief"
...
- Chatbot Arena ELO: 1370 / 1400 (LMSYS (validated))
- MT-Bench: 9.5 / 10 (OpenAI)
- Arena-Hard: 92 / 100 (OpenAI)
- GPQA Diamond: 89 / 100 (OpenAI)
- LiveBench: 88 / 100 (OpenAI)
...
1. Lead with the hook: what OpenAI actually launched with GPT-5.2, and why it matters now.
...
5. Keep the chronology explicit: this release landed on 10 Dec 2025 and should be framed against the models it is replacing or competing with.
